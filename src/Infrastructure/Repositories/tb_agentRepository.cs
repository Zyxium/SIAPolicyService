...
public class tb_agentRepository : Itb_agentRepository
{
    private readonly SIADbContext _dbContext;
    
    public tb_agentRepository(SIADbContext context)
    {
        _dbContext = context;
    }

    public string CreatePolicyPersonAsync(ValidatePersonTokenRequest request)
    {
        ...
        try
        {
            ...
            var result = _dbContext.Database.ExecuteSqlRaw(sb.ToString(),
                ...
                new SqlParameter("@Payer_Company_Prefix", ""),
                new SqlParameter("@Payer_Company_Name", ""),
                new SqlParameter("@Payer_Company_Suffix", ""),
                new SqlParameter("@Payer_Company_branch", ""),
                new SqlParameter("@Payer_Company_branch_number", ""),
