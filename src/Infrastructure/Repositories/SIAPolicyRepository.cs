...
public class SIAPolicyRepository : ISIAPolicyRepository
{
    ...
    public string CreatePolicyAsync(ValidateTokenRequest request, string agent_code)
    {
    ...
    public int UpdatePolicyAsync(string tran_id, string Cmi_Policy_no, string Cmi_Sign_no, string Url_Policy)
    {
        try
        {
