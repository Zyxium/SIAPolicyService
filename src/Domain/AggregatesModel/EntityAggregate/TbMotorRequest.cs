...
public partial class TbMotorRequest
{
    ...
    public string PmiMotCode { get; set; }
    ...
    public string PmiCommType { get; set; }

    public decimal? PmiComm { get; set; }

    public decimal? PmiCommAmt { get; set; }

    public decimal? PmiCommTax { get; set; }

    public decimal? PmiCommTaxAmt { get; set; }
    ...
    public string ImgUrlForm { get; set; }

    public string ImgUrlCarCopy { get; set; }

    public string ImgUrlPersonalCard { get; set; }
